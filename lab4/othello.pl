...
%these functions will flip all opposite tiles to the right, until a tile
%of the same color is found
...
% AI tactic is to ensure that the other play has as many moves as
% possible.
h(State, Val) :-
